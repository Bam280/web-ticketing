            ...
            <div class="feature-category-body">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-11.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-12.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-13.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-14.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-15.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-16.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-17.png"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-category-item">
                            <a href="course-grid.html">
                                <img class="item-icon" src="{{ asset('education') }}/assets/images/icon-18.png"
                                    alt="">
                ...
                <div class="row">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-1.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                ...
                                <h3 class="title"><a href="course-details.html">Design 101: Product & Web Design
                                        Course</a></h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-2.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-3.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-4.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-5.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-6.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-7.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-course">
                            <div class="courses-image">
                                <a href="course-details.html"><img
                                        src="{{ asset('education') }}/assets/images/courses/courses-8.jpg"
                                        alt="Courses"></a>
                            </div>
                            <div class="courses-content">
                                <div class="top-meta">
                ...
                <div class="col-md-6">
                    ...
                    <div class="call-to-action-images-02 text-center text-lg-end d-none d-md-block">
                        ...
                        <img class="call-to-images-shape-02 parallaxed"
                            src="{{ asset('education') }}/assets/images/shape/shape-12.svg" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="single-free-course">
                            ...
                            <div class="course-content">
                                <a href="https://youtu.be/cdZHQFCqK3g" class="play videoLightbox"><i
                                        class="fa fa-play"></i></a>
                                <h4 class="title"><a href="course-details.html">Design 101: Product & Web Design
                                        Course</a></h4>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="single-testimonial-02">
                            ...
                            <div class="testimonial-text">
                                <p>World-class training and development programs developed by top teachers Connect Fellow to
                                    the tools you love.</p>
                            </div>
